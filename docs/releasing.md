...
6. Verify the GitHub Action from a release tag, for example `uses: WeihanLi/dotnet-install@v0.3.0`, and verify local-path usage `uses: ./` if the action scripts changed.
